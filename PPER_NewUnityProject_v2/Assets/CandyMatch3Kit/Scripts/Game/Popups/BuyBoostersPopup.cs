	    ...
	    public void SetBooster(BuyBoosterButton button)
		{
			...
			switch (button.boosterType)
			{
				case BoosterType.Lollipop:
					...
					boosterNameText.text = "Injection";
					boosterDescriptionText.text = "Inject the pill of your choice to remove it from the board.";
					break;

				case BoosterType.Bomb:
					boosterImage.sprite = bombSprite;
					boosterNameText.text = "Med Kit";
					boosterDescriptionText.text = "Place your med kit to destroy all adjacent pills";
					break;

				case BoosterType.Switch:
					boosterImage.sprite = switchSprite;
					boosterNameText.text = "Medical Magnet";
					boosterDescriptionText.text = "Use your medical magnet to switch any two pills.";
					break;

				case BoosterType.ColorBomb:
					boosterImage.sprite = colorBombSprite;
					boosterNameText.text = "Band-Aid Bomb";
					boosterDescriptionText.text = "Place a band-aid bomb to destroy all pills of the same color.";
					break;
			}
